  ...
  return (
    <>
      ...
      <Box display="flex" alignItems="center" justifyContent="space-between">
        ...
        <ParagraphSmall $colorName="--eerie-black">{price?.sampleSizeCost?.show}</ParagraphSmall>
      </Box>
      {project?.enableCustomQuestion && (
        <Box display="flex" alignItems="center" justifyContent="space-between" mt={0.5}>
          ...
          <ParagraphSmall $colorName="--eerie-black">{price?.customQuestionCost?.show}</ParagraphSmall>
        </Box>
      )}
      ...
      <Box display="flex" justifyContent="flex-end">
        <ParagraphSmall $fontWeight={500} $colorName="--eerie-black" align="right">({price?.totalAmountCost?.equivalent})</ParagraphSmall>
      </Box>
    </>
  )
})
