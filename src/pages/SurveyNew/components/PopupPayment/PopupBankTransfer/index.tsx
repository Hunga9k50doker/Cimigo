            ...
            <ParagraphBody
              ...
              dangerouslySetInnerHTML={{
                __html: `${t("brand_track_popup_paynow_bank_transfer_subtitle", {
                  dueDate: moment(dataPaymentSchedule.dueDate).format("MMM yyyy"),
                })}`,
              }}
            />
            <Grid>
                  ...
                  <Grid paddingBottom={2}>
                    <BoxCustom $flexBox={true} py={0.5} pt={2} $borderTop={true}>
                      ...
                      <Heading6 $fontWeight={500} $colorName="--eerie-black">
                        {getCostCurrency(dataPaymentSchedule.totalAmount)?.VNDShow}
                      </Heading6>
                    </BoxCustom>
                ...
                <AccordionDetails>
                  ...
                  <Grid paddingBottom={2}>
                    <BoxCustom $flexBox={true} py={0.5} pt={2} $borderTop={true}>
                      ...
                      <Heading6 $fontWeight={500} $colorName="--eerie-black">
                        {getCostCurrency(dataPaymentSchedule.totalAmountUSD)?.USDShow}
                      </Heading6>
                    </BoxCustom>
