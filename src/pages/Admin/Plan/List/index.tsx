...
import { DataPagination, EStatus, LangSupport, langSupports, OptionItemT, TableHeaderLabel } from "models/general";
...
const PlanList = memo(({ keyword, setKeyword, data, setData, filterData, setFilterData }: Props) => {
  ...
  const fetchData = (value?: { take?: number, page?: number, keyword?: string, filter?: FilterValue }) => {
