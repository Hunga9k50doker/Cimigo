...
import CreateSolution from "./Solution/Create"
  ...
  return (
    <>
     <Switch>
        ...
        <Route exact path={routes.admin.solutionCategory.solution.create} component={CreateSolution}/>
        <Route exact path={routes.admin.solutionCategory.solution.edit} component={EditSolution}/>
