...
import { Button, IconButton, Grid, FormControl, Input,  Container } from '@mui/material';
...
const PopupSingleChoice = (props) => {
  ...
  const togglePopup = (props) =>{ setOpen(!open); }
    return <React.Fragment> {   open && <Grid style={{'paddingBottom':'100px'}}>
